...
• Still broken? One click copies a draft when possible and opens your email app if one is
  available. You read it and send it — StampStack transmits nothing. It names the site and
  lists your StampStack settings, and nothing else: no page content, not even the full URL
