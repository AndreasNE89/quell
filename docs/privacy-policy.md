...
Quell does **not** collect, sell, or transmit your browsing history. Filtering runs on your device. Settings stay in your browser’s local storage.

## Who we are

Quell is an open-source browser extension that blocks ads and trackers using Declarative Net Request (Manifest V3) and local cosmetic/scriptlet filters.

Repository: https://github.com/AndreasNE89/quell

## Data we collect

**We do not collect personal data.** Quell does not operate analytics, crash reporting, advertising identifiers, or remote logging.
...
| Statistics | On-device only when available. Not synced to a Quell server. |
...
Filter lists may be downloaded from their publishers when you update lists. Quell does not send browsing history to list publishers as part of filtering. We do not sell or share user data.
