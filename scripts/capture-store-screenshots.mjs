...
Generated by \`scripts/capture-store-screenshots.mjs\` (Playwright Chromium + \`--load-extension=dist\`).

| File | Content | Size |
|------|---------|------|
| \`01-popup-1280x800.png\` | Toolbar popup UI | 1280×800 |
| \`02-options-1280x800.png\` | Options / settings page | 1280×800 |

CWS accepts 1280×800 or 640×400. At least one screenshot is required.
`,
  );
  console.log('Done.');
} finally {
